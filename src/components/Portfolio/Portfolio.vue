            ...
            <div class="container px-4 lg:px-12 py-12 xl:px-20 xl:py-24">
                ...
                <div class="grid gap-4 grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 font-semibold text-gray-500 text-lg pb-6">
                    ...
                    <div class="" v-for="(category, index) in categories" :key="index">
                        <router-link :to="{ path: '/portfolio/' + category.slug }">
                            <p class="text-sm sm:text-base">{{ category.title }}</p>
                        </router-link>
                    </div>
                </div>
                ...
                <div>
                    <div class="box-weidth">
                        <div class="border bg-background rounded-2xl border-gray-300" v-for="(project, index) in projects" :key="index">
                            <div class="w-full">
                                ...
                                <div class="p-4 text-left rounded-b-2xl">
